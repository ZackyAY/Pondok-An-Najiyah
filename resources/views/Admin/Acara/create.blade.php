...
<div class="max-w-2xl mx-auto p-4 bg-white shadow-md rounded-lg mt-10">
    <h1 class="text-2xl font-bold mb-6">Tambah Acara</h1>
    <form action="{{ route('admin.acara.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <a href="{{ route('admin.acara.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
            Back
        </a>
    </form>
</div>
