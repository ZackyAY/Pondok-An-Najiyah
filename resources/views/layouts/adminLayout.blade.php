            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.alumni.index') }}"
                        class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group @if (Request::is('admin/alumni')) bg-gray-200 text-gray-900 @endif">
                        <?xml version="1.0" ?><svg height="24" id="svg3171" version="1.1" <svg
