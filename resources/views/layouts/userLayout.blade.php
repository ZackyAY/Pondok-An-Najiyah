...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/alumni-dropdown.js'])
...
<body>
        ...
        <div class="flex flex-wrap items-center justify-between mx-auto p-4" data-aos="zoom-in" data-aos-easing="ease-in" data-aos-duration="2000">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="/alumni"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Alumni</a>
                    </li>
                    <li class="relative group">
                        ...
                        <ul id="sekolahDropdown"
                            class="absolute hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white mt-2 space-y-2 rounded shadow-lg">
                            <li><a href="/alumni/2024" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-700">TK</a></li>
                            <li><a href="/alumni/2023" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-700">SD</a></li>
                            <li><a href="/alumni/2022" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-700">SMP</a></li>
                            <li><a href="/alumni/2022" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-700">SMA</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="/contact"
    ...
    <script src="{{ asset('js/alumni-dropdown.js') }}" defer></script>
    <script>
        AOS.init();
    </script>
</body>
