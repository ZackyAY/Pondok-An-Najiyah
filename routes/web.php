...
Route::middleware('auth')->group(function () {
    ...
    Route::get('admin/alumni/tambah',[AlumniController::class, 'create'])->name('admin.alumni.create');
    Route::post('admin/alumni/tambahdata',[AlumniController::class, 'store'])->name('admin.alumni.store');
});
